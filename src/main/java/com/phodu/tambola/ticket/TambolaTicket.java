package com.phodu.tambola.ticket;
...
/**
 * This class represents a tambola game ticket
...
public class TambolaTicket {
	...
	public TambolaTicket(TambolaBoard pBoard, Profile pProfile, int[] row1, int[] row2, int[] row3) {
		this.board = pBoard;
